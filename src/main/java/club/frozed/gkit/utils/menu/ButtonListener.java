package club.frozed.gkit.utils.menu;

import club.frozed.gkit.FrozedGKits;
import club.frozed.gkit.utils.menu.pagination.PaginatedMenu;
...
public class ButtonListener implements Listener {
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        ...
        if (player.hasMetadata("scanglitch")) {
            player.removeMetadata("scanglitch", FrozedGKits.getInstance());
