...
public class CommandFramework implements CommandExecutor {
    ...
    private final FrozedGKits plugin;

    public CommandFramework(FrozedGKits plugin) {
        this.plugin = plugin;
    ...
    public boolean handleCommand(CommandSender sender, org.bukkit.command.Command cmd, String label, String[] args) {
        for (int i = args.length; i >= 0; i--) {
            ...
            if (commandMap.containsKey(cmdLabel)) {
                ...
                if (command.isAdminOnly() && !sender.hasPermission("frozedgkits.admin")) {
    ...
    public void registerHelp() {
        ...
        IndexHelpTopic topic = new IndexHelpTopic(plugin.getName(), "All commands for " + plugin.getName(),
                null, help, "Below is a list of all " + plugin.getName() + " commands:");
